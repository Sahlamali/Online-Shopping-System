...
out.println("Select the product to be deleted:<br>"); 
int i=0;
while(rs.next()){
...
%>
			<form action='deleteproduct.jsp'><br>
			<input type='checkbox' name='product' value='<%=pid%> '>
<%
				out.println("Product ID:" + pid + "<br>" + "Product Name:" + pname + "<br>");
			}
