...
while(rs.next()){
			...
			String bemail = rs.getString("buyeremail");
%>
			<form action='deletebuyer.jsp'><br>
			<input type='checkbox' name='buying' value='<%=bid%> '>
<%
				out.println("SellerID:" + bid + "<br>" + "SellerName:" + bname + "<br>");
			}
