...
String[] picked = request.getParameterValues("buying");
//out.println("Successfully deleted the following");
			for(int i =0;i<picked.length;i++){

			
			//out.println("<li>"+picked[i]);
			stmt.executeUpdate("delete from buyer where bid="+picked[i]);
			...
			Successfully deleted the products
			 <a href="viewbuyer.jsp" id="linksbelow">Click to see the Buyers List</a>
