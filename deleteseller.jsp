...
String[] picked = request.getParameterValues("selling");
//out.println("Successfully deleted the following");
			for(int i =0;i<picked.length;i++){

			
			//out.println("<li>"+picked[i]);
			stmt.executeUpdate("delete from seller where sid="+picked[i]);
			stmt.executeUpdate("delete from productseller where sid="+picked[i]);
            }
			...
			Successfully deleted the products
			 <a href="viewseller.jsp" id="linksbelow">Click to see the Seller List</a>
